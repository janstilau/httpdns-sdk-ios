...
static NSString * const DB_HttpDNS_IPV4_Channel = @"httpDnsCache_AChannel";
static NSString * const DB_HttpDNS_IPV4_ClientIP = @"httpDnsCache_AclientIP";
static NSString * const DB_HttpDNS_IPV4_TimeConsuming = @"httpDnsCache_AtimeConsuming";
static NSString * const DB_HttpDNS_IPV4_TTL = @"httpDnsCache_Attl";
static NSString * const DB_HttpDNS_IPV4_TTLExpired = @"httpDnsCache_AttlExpried";
